...
//   
//    
////    private ArrayList<ArrayList<Sentence>> subSetMaker(int m, int pos, int depth, Sentence[] inequalities, ArrayList<Sentence> currentSet, ArrayList<ArrayList<Sentence>> superSet){
////        int iterLim = inequalities.length-m+pos+1;
////        for(int i = pos; i<iterLim; i++){
////            if(i+depth>=inequalities.length)
////                return superSet;
////            ArrayList<Sentence> newSet = new ArrayList<Sentence>(currentSet);
////            Sentence sentenceToAdd = inequalities[i + depth];
////            newSet.add(sentenceToAdd);
////            if(newSet.size()==m)
////                superSet.add(newSet);
////                superSet = subSetMaker(m, i, depth+1, inequalities, newSet, superSet);
////        }
////        return superSet;
////    }
//
...
//        if(testSolution(inequalities,c,ans.ansx))
...
//    
//    
//    private boolean testSolution(Sentence[] sentences, double[] c, double[] x){
//        boolean rtrn = true;
//        double returnedMax = evaluate(c, x);
//        double[] test = Arrays.copyOf(x, x.length);
//        for(int i=0;i<sentences[0].coefficients.length;i++){
//            for(int k=-1;k<=1;k+=2){
//                test[i] = test[i]+k;
//                double comp = evaluate(c,test);
//                if(comp>returnedMax){
//                    for(int j=0;j<sentences.length;j++){
//                        if(evaluate(test,sentences[j].coefficients)<=sentences[j].constant){
//                            System.out.printf("%f, item %d of solution, can be changed by %d%n",x[i], i, k);
//                            rtrn = false;
//                        }
//                    }
//                }            
...
//    }
//    
//    private double evaluate(double[] coef, double[] vals){
//        double rtrn = 0;
//        if(coef.length!=vals.length){
//            System.out.printf("Error: vals is length %d and coef is length %d%n", vals.length, coef.length);
//            return 0;
//        }
...
//        Sentence[] sentences = new Sentence[m+n+1];
//        System.out.printf("%d %d%n", n, m);
//        for(int i=0;i<n;i++){
//            sentences[i] = new Sentence(m, Comparator.LESSOREQUAL);
//            sentences[i].constant = rnd.nextInt(100000) - 50000;
//        }
//        for(int i=0;i<n;i++){
//            for(int j=0;j<sentences[i].coefficients.length;j++){
//                sentences[i].coefficients[j] = rnd.nextInt(200) - 100;
//                System.out.printf("%.0f ", sentences[i].coefficients[j]);
//            }
//            System.out.println();
//        }
//        System.out.println();
//        
//        for(int i=n;i<sentences.length-1;i++){
//            sentences[i] = new Sentence(m, Comparator.GREATEROREQUAL);
//            for(int j=0; j<m; j++){
//                if(j==i-n){
//                    sentences[i].setCoefficient(j, 1);
//                } else {
//                    sentences[i].setCoefficient(j, 0.000000000000);
//                }
//            }
//            sentences[i].setConstant(0.000000000000);
//        }
//        int lastIneq = sentences.length-1;
//        sentences[lastIneq] = new Sentence(m, Comparator.LESSOREQUAL);
//        for(int i=0;i<m;i++){
//            sentences[lastIneq].setCoefficient(i, 1);
//            sentences[lastIneq].setConstant(1000000000);
//        }
//        for(int i=0;i<n;i++){
//            System.out.printf("%.0f ", sentences[i].constant);
//        }
//        System.out.println();
//        double[] expressionCoefficients = new double[m];
//        for(int i=0; i< expressionCoefficients.length;i++){
//            expressionCoefficients[i] = rnd.nextInt(200) - 100;
//            System.out.printf("%.0f ", expressionCoefficients[i]);
//        }
//        System.out.println();
//        LinearProgram lp = new LinearProgram(expressionCoefficients);
//        int ineqNum = 0;
//        for(int i=0;i<n;i++){
//            Sentence s = sentences[i];
//            lp.addConstraint(new LinearSmallerThanEqualsConstraint(s.coefficients, s.constant, "c" + ineqNum));
//            ineqNum++;
//        }
...
//        
//        Answer ans = solveDietProblem(n+m, m, sentences, expressionCoefficients);
//        if (ans.anst == -1) {
...
//            for (int i = 0; i < m; i++) {
//                System.out.printf("%.18f%c", ans.ansx[i], i + 1 == m ? '\n' : ' ');
//            }
//            return;
//        }
//        if (ans.anst == 1) {
